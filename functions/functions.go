...
func Exit(tk obj.Token, args []oop.VarDef) oop.Val {
	code := args[0].Val
...
func Input(tk obj.Token, args []oop.VarDef) oop.Val {
	args[0].Val.Print()
...
func Int(tk obj.Token, args []oop.VarDef) oop.Val {
...
// Calloc list by size.
func Calloc(tk obj.Token, args []oop.VarDef) oop.Val {
	size := args[0].Val
...
func Realloc(tk obj.Token, args []oop.VarDef) oop.Val {
...
// Print values to cli.
func Print(tk obj.Token, args []oop.VarDef) oop.Val {
...
func Println(tk obj.Token, args []oop.VarDef) oop.Val {
	Print(tk, args)
	println()
	return oop.Val{}
}
...
func Range(tk obj.Token, args []oop.VarDef) oop.Val {
	start := args[0].Val
	to := args[1].Val
	step := args[2].Val
...
func String(tk obj.Token, args []oop.VarDef) oop.Val {
...
func Panic(tk obj.Token, args []oop.VarDef) oop.Val {
